...
const targetImports = `import { Compass, FilmIcon, Tv, Search, Filter, Play, Check, X, Star, Globe, Calendar, Target, Sparkles, Smile, Shield, Ghost, Heart, Zap, History } from "lucide-react";`;
const replacementImports = `import { Compass, FilmIcon, Tv, Search, Filter, Play, Check, X, Star, Globe, Calendar, Target, Sparkles, Smile, Shield, Ghost, Heart, Zap, History } from "lucide-react";
