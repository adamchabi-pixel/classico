...
export const COLLECTIONS: Collection[] = [
  {
    id: "john-wick",
    title: "John Wick",
    description: "L'art de la guerre et de la vengeance chorégraphiée. Une saga d'action légendaire menée par Keanu Reeves.",
    movies: [
      {
        id: "john-wick-1",
        title: "John Wick",
  ...
  },
  {
    id: "indiana-jones",
    title: "Indiana Jones",
    description: "Le fouet, le chapeau et les mystères de l'histoire. Suivez le plus grand archéologue-aventurier de tous les temps.",
    movies: [
      {
        id: "indy-1",
  ...
  },
  {
    ...
    description: "Des dialogues percutants, une violence stylisée et des bandes-son inoubliables. L'œuvre unique du maître Quentin Tarantino.",
    movies: [
      {
        id: "pulp-fiction",
        title: "Pulp Fiction",
  ...
  },
  {
    ...
    description: "Le temps distordu, la réalité fragmentée et des visions d'une ampleur inégalée. Le cinéma conceptuel de Christopher Nolan.",
    movies: [
      {
        id: "inception",
        title: "Inception",
  ...
  },
  {
    id: "star-wars",
    title: "Star Wars",
    description: "La saga spatiale légendaire. Une lutte éternelle entre la Force et le Côté Obscur à travers la galaxie.",
    movies: [
      {
        id: "sw-1",
      ...
      {
        id: "sw-7",
        title: "Épisode VII : Le Réveil de la Force",
        year: 2015,
        duration: "138 min",
        rating: "7.8",
        director: "J.J. Abrams",
      ...
      {
        id: "sw-8",
        title: "Épisode VIII : Les Derniers Jedi",
        year: 2017,
        duration: "152 min",
        rating: "6.9",
      ...
      {
        id: "sw-9",
        title: "Épisode IX : L'Ascension de Skywalker",
        year: 2019,
        duration: "142 min",
        rating: "6.4",
        director: "J.J. Abrams",
  ...
  },
  {
    id: "james-bond",
    title: "James Bond",
    description: "Le flegme britannique, les gadgets hi-tech et le permis de tuer. Les plus grandes missions de l'espion iconique.",
    movies: [
      {
        id: "bond-dr-no",
  ...
  },
  {
    id: "rocky",
    title: "Rocky",
    description: "Le combat d'une vie. L'ascension inspirante de l'Étalon Italien d'un quartier modeste de Philadelphie au sommet du monde.",
    movies: [
      {
        id: "rocky-1",
        title: "Rocky",
        ...
        genre: ["Sport", "Drame"],
        description: "Rocky Balboa, boxeur d'un club miteux de Philadelphie accumulant les dettes, se voit proposer par un coup de pouce du destin d'affronter le champion du monde invaincu Apollo Creed pour un combat vedette historique.",
        gradient: "from-neutral-900 via-amber-950/30 to-zinc-900",
        accentColor: "text-amber-500 border-amber-500/30 bg-amber-500/10",
        accentHex: "#f59e0b",
        symbol: "🥊🏃🥩",
        tagline: "Tout le monde mérite sa chance de gloire."
      },
      {
        id: "rocky-2",
        title: "Rocky II : La Revanche",
        year: 1979,
        duration: "119 min",
        rating: "7.3",
        ...
        cast: ["Sylvester Stallone", "Talia Shire", "Burt Young", "Carl Weathers"],
        genre: ["Sport", "Drame"],
        description: "Après avoir tenu la distance de manière héroïque face au champion du monde Apollo Creed, le peuple réclame une revanche spectaculaire. Rocky Balboa cherche d'abord à s'installer en famille avant de retourner aux gants.",
        gradient: "from-neutral-900 via-stone-900 to-amber-950/20",
        accentColor: "text-yellow-400 border-yellow-400/30 bg-yellow-400/10",
        accentHex: "#facc15",
        symbol: "💍🦁👊",
        tagline: "Une revanche que tout le monde attendait."
      },
      {
        id: "rocky-3",
        title: "Rocky III : L'Œil du tigre",
        year: 1982,
        duration: "99 min",
        rating: "6.9",
        director: "Sylvester Stallone",
        ...
        genre: ["Sport", "Drame"],
        description: "Rocky s'est reposé sur ses lauriers et encaisse une cuisante défaite par K.O. face au féroce et arrogant Clubber Lang. Apollo Creed, son ancien rival, s'érige comme mentor inattendu pour lui redonner 'l'œil du tigre'.",
        gradient: "from-neutral-900 via-amber-950/30 to-neutral-950",
        accentColor: "text-amber-500 border-amber-500/30 bg-amber-500/10",
        accentHex: "#ca8a04",
        symbol: "🐯🏆⚡",
        tagline: "Retrouvez la rage de vaincre."
      },
      {
        id: "rocky-4",
        title: "Rocky IV",
        ...
        genre: ["Sport", "Drame"],
        description: "Lorsque son ami de toujours Apollo Creed meurt tragiquement sur le ring tué par le colosse soviétique sans pitié Ivan Drago, Rocky Balboa décide de s'entraîner dur au cœur de la Sibérie sauvage pour l'affronter à Moscou.",
        gradient: "from-blue-950/40 via-red-950/30 to-neutral-900",
        accentColor: "text-red-500 border-red-500/30 bg-red-500/10",
        accentHex: "#ef4444",
        symbol: "🧥❄️🇷🇺",
        tagline: "Un combat qui dépasse les frontières géopolitiques."
      },
      {
        id: "rocky-5",
        title: "Rocky V",
        ...
        genre: ["Sport", "Drame"],
        description: "Ruine financièrement et contraint de prendre sa retraite de la boxe en raison de séquelles physiques, Rocky retourne dans les faubourgs de Philadelphie et forme un jeune prodige fougueux appelé Tommy Gunn.",
        gradient: "from-neutral-900 via-zinc-950 to-stone-900",
        accentColor: "text-neutral-400 border-neutral-400/30 bg-neutral-400/10",
        accentHex: "#94a3b8",
        symbol: "🏚️👦🏼🧥",
        tagline: "Le vrai combat n'est pas sur le ring."
      },
      {
        id: "rocky-6",
        title: "Rocky Balboa",
        ...
        genre: ["Sport", "Drame"],
        description: "Détenant un modeste restaurant, Rocky souffre toujours de la mort d'Adrian. Lorsqu'une simulation télévisée le déclare vainqueur virtuel du champion actuel, Rocky consent à rendosser les gants pour une dernière revanche d'honneur.",
        gradient: "from-stone-950 via-neutral-900 to-amber-950/15",
        accentColor: "text-amber-400 border-amber-400/30 bg-amber-400/10",
        accentHex: "#fbbf24",
        symbol: "🍽️🐕🏟️",
        tagline: "Il s'agit de savoir combien d'impacts tu peux encaisser sans broncher."
      }
    ]
  },
  {
    id: "terminator",
    title: "Terminator",
    description: "La résistance humaine face à l'insurrection de Skynet et des cyborgs. Une boucle temporelle d'action cybernétique pure.",
    movies: [
      {
        id: "terminator-1",
        title: "Terminator",
  ...
  },
  {
    ...
    description: "Vitesse, grosses cylindrées, famille et cascades spectaculaires. L'intégrale de la saga légendaire d'action menée par Vin Diesel et Paul Walker, et propulsée vers la gloire par le réalisateur prodige Justin Lin.",
    movies: [
      {
        id: "fast-1",
        title: "Fast & Furious",
